...
class ApplicationController < ActionController::Base
  ...
  def authenticate!
    ...
    #warden.authenticate!
    #File.open("/opt/ISSC/daniel.log", "a+") { |f| f.puts t.strftime("%H:%M:%S:%L") + " [daniel] application_controller.rb, authenticate!().request: " }
  end
  ...
  def parse_request(expected_entity_type = nil)
    #File.open("/opt/ISSC/daniel.log", "a+") { |f| f.puts t.strftime("%H:%M:%S:%L") + " [daniel] application_controller.rb, parse_request().request: " + request }
